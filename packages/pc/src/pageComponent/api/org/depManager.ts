...
const api = {
  ...
  getDepData: (url?: string) => (params: any) => {
    return instance.get(url ?? "/comlite/v1/department/all", { params });
  },
  /**
   * 新增部门
   */
  insertDepRecord: (url?: string) => (data: any) => {
    return instance.post(url ?? "/comlite/v1/department/add", data);
  },
  ...
  updateDepRecord: (url?: string) => (data: any) => {
    return instance.post(url ?? "/comlite/v1/department/modify", data);
  },
  /**
   * 删除部门
   */
  deleteDepById: (url?: string) => (departmentId: number) => {
    return instance.get(
      `${url ?? "/comlite/v1/department/remove/"}${departmentId}`
    );
  },
  /**
   * 获取部门下的员工下拉列表
  ...
  sortDepList: (url?: string) => (data: any) => {
    return instance.post(url ?? "/comlite/v1/department/sort/adjust", data);
  },
  ...
  getDetail: (url?: string) => (params: any) => {
    return instance.get(`${url ?? "/comlite/v1/department/detail/"}${params}`);
  },
  ...
  getEmployeeList: (url?: string) => (params: any) => {
    return instance.get(url ?? "/comlite/v1/employee/all/page", { params });
  },
  /**
   * 获取岗位下拉列表
   */
  getPostList: (url?: string) => () => {
    return instance.get(url ?? "/comlite/v1/jobPost/all/summary");
  },
  /**
   * 获取员工详细信息 查看/编辑 回显
   */
  ...
  insetEmployee: (url?: string) => (data: any) => {
    return instance.post(url ?? "/comlite/v1/employee/add", data);
  },
  /**
   * 修改员工信息
   */
  updateEmployee: (url?: string) => (data: any) => {
    return instance.post(url ?? "/comlite/v1/employee/modify", data);
  },
  /**
   * 删除员工
   */
  deleteEmployeeById: (url?: string) => (employeeId: number) => {
    return instance.get(
      `${url ?? "/comlite/v1/employee/remove/"}${employeeId}`
    );
  },
};

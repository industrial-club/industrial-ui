...
import { Form, message, Spin } from 'ant-design-vue';
...
export default defineComponent({
  ...
  setup(prop, context) {
    ...
    const getImg = async () => {
      const res = await instance.get('/comlite/v1/auth/code/get');
    ...
    const checkImg = async () => {
      ...
      const res = await instance.post('/comlite/v1/auth/code/check', {
        imageToken,
        sliderTrack: [
          {
